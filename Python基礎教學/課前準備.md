...
+ [Sublime 3](https://www.sublimetext.com/) - 如果使用 Windows 可以參考[這一篇](https://killer0001.blogspot.com/2017/01/python-sublime-text-3.html)設定你的環境（但注意，裡面有建議安裝 Anaconda 套件，因為版本可能與你的 Anaconda 有衝突，請不要安裝）
